...
- **Forked from:** upstream **v2.2**, plus a backport of the `src/Mappers/` component from a later
  upstream release and a small number of local edits made for production use.
- **Modifications:** Copyright © 2026 Sila Visions.
...
release, which reproduces the exact production behaviour.
